export default class PubSub {
     ...
     * First need to subscribe to an event to create it, afterwards
    ...
    subscribe(event, callback) {
        ...
        // create a new one and set it with an empty array to have multiple callbacks
        // so we don't have to type check it later down-the-line
